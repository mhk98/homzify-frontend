...
function CheckoutContent() {
  ...
  const paymentMethods = [
    { id: "cod" as const, label: "Cash on Delivery", number: null, bg: "#001B54" },
        ...
        <main style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 16px" }}>
          <div style={{ background: "#fff", borderRadius: 16, padding: "48px 40px", textAlign: "center", boxShadow: "0 4px 24px rgba(0,0,0,0.10)", maxWidth: 460, width: "100%" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <Link href="/track-order" style={{ display: "block", background: "#001B54", color: "#fff", padding: "13px 0", borderRadius: 8, fontWeight: 700, fontSize: 14, textDecoration: "none" }}>
                Order Track করুন
              </Link>
        ...
        <div style={{ width: "92%", maxWidth: 1300, margin: "0 auto" }}>
          <div className="checkout-main-grid">
            ...
            <div style={{ background: "#fff", borderRadius: 10, overflow: "hidden", boxShadow: "0 2px 8px rgba(0,0,0,0.08)" }}>
              ...
              {/* Purple header */}
              <div style={{ background: "#001B54", padding: "18px 28px" }}>
              ...
              <div style={{ padding: "30px 28px", display: "flex", flexDirection: "column", gap: 20 }}>
                ...
                <div>
                  ...
                  {district && (
                    <p style={{ margin: "6px 0 0", fontSize: 13, color: "#8F6A25", fontWeight: 500 }}>
                ...
                <button
                  ...
                  disabled={loading}
                  style={{
                    background: loading ? "#aaa" : "#B68A35", color: "#fff", border: "none", borderRadius: 8,
              ...
              <div style={{ padding: "0 22px 22px" }}>
                <div style={{ display: "flex", gap: 10 }}>
                  ...
                  <button
                    ...
                    style={{
                      background: couponLoading ? "#9ca3af" : "#001B54", color: "#fff", border: "none", borderRadius: 8,
